            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Register Pasien</h4>
                        <p class="mb-4">Rumah Sakit Tadika Mesra</p>

                        <form id="formAuthentication" class="mb-3" method="POST"
                            action="{{ route('register.post') }}">
                            @csrf
                            <div class="mb-3">
                                <label for="username" class="form-label">No KTP</label>
                                <input name="no_ktp" type="text" class="form-control" id="username"
                                    placeholder="Enter your KTP" autofocus />
                            </div>
                            <div class="mb-3">
                                <label for="username" class="form-label">Nama</label>
                                <input name="name" type="text" class="form-control" id="username"
                                    placeholder="Enter your Nme" autofocus />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="no_hp" type="text" class="form-control" id="username"
                                    placeholder="Enter your No HP" autofocus />
                            </div>
                            <div class="mb-3">
                                <label for="username" class="form-label">Alamat</label>
                                <input name="alamat" type="text" class="form-control" id="username"
                                    placeholder="Enter your No HP" autofocus />
                            </div>
